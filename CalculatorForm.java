...
public class CalculatorForm {
    ...
    public void testClick(String botton) {
    }
    ...
    public void tsetClick(String button) throws Exception {
        switch (button) {
            case "+": buttonAdd.doClick();
                break;
            case "-": buttonSub.doClick();
                break;
            case "*": buttonMultiply.doClick();
                break;
            case "/": buttonDivide.doClick();
                break;
            case ".": buttonDot.doClick();
                break;
            case "=": buttonEqual.doClick();
                break;
            case "CE": buttonCE.doClick();
                break;
            case "ClS": buttonClS.doClick();
                break;
